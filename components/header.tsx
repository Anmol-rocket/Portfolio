...
export default function Header() {
  ...
  return (
    <header
      className={cn(
        ...
        scrolled
          ? "bg-white/70 dark:bg-black/60 backdrop-blur-lg border border-white/40 dark:border-transparent dark:shadow-lg dark:backdrop-blur-lg"
          : "bg-white/70 dark:bg-black/60 backdrop-blur-lg shadow-lg border dark:border-transparent dark:shadow-lg dark:backdrop-blur-lg",
        "glassmorphism"
      )}
    >
      <div className="container flex h-16 items-center justify-between">
        <Link href="/" className="flex items-center space-x-2">
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
          >
            <span className="text-2xl font-bold gradient-text">AU</span>
          </motion.div>
        </Link>
        {/* Desktop Navigation */}
  <nav className="hidden md:flex items-center space-x-6">
          ...
          {/* ModeToggle restored to previous position, isolated with flex-shrink-0 */}
      ...
      >
  <div className="container py-4 bg-background/95 dark:bg-black/60 backdrop-blur-lg border border-white/20 dark:border-transparent dark:shadow-lg dark:backdrop-blur-lg">
